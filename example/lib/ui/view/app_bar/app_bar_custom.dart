...
/// app bar, see [AnapaSliverAppBar], which embeds an [AnapaAppBar] in a sliver for use in
/// a [CustomScrollView].
///
...
/// English):
///
/// The [AnapaAppBar] insets its content based on the ambient [MediaQuery]'s padding,
/// to avoid system UI intrusions. It's taken care of by [Scaffold] when used in
/// the [Scaffold.appBar] property. When animating an [AnapaAppBar], unexpected
/// [MediaQuery] changes (as is common in [Hero] animations) may cause the content
/// to suddenly jump. Wrap the [AnapaAppBar] in a [MediaQuery] widget, and adjust its
...
///
/// If the [leading] widget is omitted, but the [AnapaAppBar] is in a [Scaffold] with
...
///
/// {@tool dartpad}
/// This sample shows an [AnapaAppBar] with two simple actions. The first action
...
/// {@tool dartpad}
/// This sample shows the creation of an [AnapaAppBar] widget with the [shadowColor] and
...
///
/// {@tool dartpad}
/// This sample shows an [AnapaAppBar] with two action buttons with their primary
...
/// See also:
///
///  * [Scaffold], which displays the [AnapaAppBar] in its [Scaffold.appBar] slot.
///  * [AnapaSliverAppBar], which uses [AnapaAppBar] to provide a flexible app bar that
///    can be used in a [CustomScrollView].
///  * [TabBar], which is typically placed in the [bottom] slot of the [AnapaAppBar]
...
class AnapaAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// Used by [Scaffold] to compute its [AnapaAppBar]'s overall height. The returned value is
  /// the same `preferredSize.height` unless [AnapaAppBar.toolbarHeight] was null and
  ...
  /// the app bar's [AnapaAppBar.bottom] widget.
  ...
  /// [AnapaAppBar] will imply an appropriate widget. For example, if the [AnapaAppBar] is
  /// in a [Scaffold] that also has a [Drawer], the [Scaffold] will fill this
  /// widget with an [IconButton] that opens the drawer (using [Icons.menu]). If
  /// there's no [Drawer] and the parent [Navigator] can go back, the [AnapaAppBar]
  ...
  /// See also:
  ///
  ///  * [Scaffold.appBar], in which an [AnapaAppBar] is usually placed.
  ...
  ///
  /// A flexible space isn't actually flexible unless the [AnapaAppBar]'s container
  /// changes the [AnapaAppBar]'s size. A [AnapaSliverAppBar] in a [CustomScrollView]
  /// changes the [AnapaAppBar]'s height when scrolled.
  ///
  ...
  /// null, then [AnapaAppBar] uses the overall theme's [ColorScheme.primary] if the
  ...
  /// value is also null, then [AnapaAppBar] uses the overall theme's
  ...
  /// used by [AnapaSliverAppBar] to animate the opacity of the toolbar when the app
  /// bar is scrolled.
  /// {@endtemplate}
  ...
  /// Defines the height of the toolbar component of an [AnapaAppBar].
  ///
  ...
  @override
  State<AnapaAppBar> createState() => _AnapaAppBarState();
}

class _AnapaAppBarState extends State<AnapaAppBar> {
...
/// the screen see [AnapaAppBar], which is used in the [Scaffold.appBar] slot.
///
...
///
/// {@tool dartpad}
/// This sample shows a [AnapaSliverAppBar] and it's behavior when using the
...
/// See also:
///
///  * [CustomScrollView], which integrates the [AnapaSliverAppBar] into its
///    scrolling.
///  * [AnapaAppBar], which is a fixed-height app bar for use in [Scaffold.appBar].
///  * [TabBar], which is typically placed in the [bottom] slot of the [AnapaAppBar]
///    if the screen has multiple pages arranged in tabs.
///  * [IconButton], which is used with [actions] to show buttons on the app bar.
///  * [PopupMenuButton], to show a popup menu on the app bar, via [actions].
...
///    can expand and collapse.
///  * <https://material.io/design/components/app-bars-top.html>
class AnapaSliverAppBar extends StatefulWidget {
  /// Creates a Material Design app bar that can be placed in a [CustomScrollView].
  ///
  /// The arguments [forceElevated], [primary], [floating], [pinned], [snap]
  /// and [automaticallyImplyLeading] must not be null.
  const AnapaSliverAppBar({
    super.key,
    this.leading,
    this.automaticallyImplyLeading = true,
    this.title,
  ...
  ///
  /// Returns a [AnapaSliverAppBar] configured with appropriate defaults
  ...
  /// See also:
  ///
  ///   * [AnapaAppBar], for a small or center-aligned top app bar.
  ...
  factory AnapaSliverAppBar.medium({
    Key? key,
    Widget? leading,
  ...
  ///   * https://m3.material.io/components/top-app-bar/overview, the Material 3
  ///     app bar specification.
  factory AnapaSliverAppBar.large({
    Key? key,
    Widget? leading,
    bool automaticallyImplyLeading = true,
    Widget? title,
  ...
  ///
  /// This property is used to configure an [AnapaAppBar].
  final Widget? leading;
  ...
  /// content is not scrolled under the [AnapaAppBar].
  ///
  /// Defaults to false, meaning that the [elevation] is only applied when the
  /// [AnapaAppBar] is being displayed over content that is scrolled under it.
  ///
  ...
  /// See also:
  ///
  ///  * [AnapaSliverAppBar] for more animated examples of how this property changes the
  ...
  @override
  State<AnapaSliverAppBar> createState() => _AnapaSliverAppBarState();
}

// This class is only Stateful because it owns the TickerProvider used
// by the floating appbar snap animation (via FloatingHeaderSnapConfiguration).
class _AnapaSliverAppBarState extends State<AnapaSliverAppBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(AnapaSliverAppBar oldWidget) {
